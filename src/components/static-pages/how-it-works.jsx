...
import { HOW_IT_WORKS, TERMS_CONDITION } from "../../constants";
...
const HowItWorks = () => {
  ...
  const getPrivacyPolicy = async () => {
    try {
      const response = await httpRequest.get(HOW_IT_WORKS, {
        headers: {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <h1 className="text-2xl font-semibold mb-6">How It Works</h1>
      <ReactQuill
        theme="snow"
        value={content}
        onChange={setContent}
