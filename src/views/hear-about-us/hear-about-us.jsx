...
import { HEAR_ABOUT_US } from "../../constants";
...
function HearAboutUs() {
  ...
  const handleDelete = async (id) => {
    try {
      const response = await deleteData(`${HEAR_ABOUT_US}/${id}`);
