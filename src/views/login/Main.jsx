...
function Main() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Error is handled by useEffect and toast.error
          ...
          <div className="block xl:grid grid-cols-2 gap-4">
            ...
            <div className="hidden xl:flex flex-col min-h-screen">
              <a href="" className="-intro-x flex items-center pt-5">
                ...
                {/* <span className="text-white text-5xl ml-3 logo_admin "> Koerier Platform </span> */}
              </a>
            ...
            <div className="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
              <div className="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                <h2 className="intro-x font-bold text-2xl xl:text-2xl text-center xl:text-left uppercase">
                  Sign In
                </h2>
