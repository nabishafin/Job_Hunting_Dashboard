import {
  ...
  function CategoryOption() {
    ...
    const handleDelete = async (id) => {
      try {
        const response = await deleteData(`${CATEGORY_DROPDOWN}/${id}`);
      ...
      <>
        ...
        <div className="grid grid-cols-12 gap-6 mt-5">
          <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            <div>
              <p className="text-lg font-medium">Category Dropdown</p>
            </div>
            <div>
              <Link to={"/add-category-option"}>
