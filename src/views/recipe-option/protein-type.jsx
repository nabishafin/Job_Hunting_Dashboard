import {
  ...
  function ProteinTypeOption() {
    ...
    const handleDelete = async (id) => {
      try {
        const response = await deleteData(`${PROTEIN_STYLE_DROPDOWN}/${id}`);
      ...
      <>
        ...
        <div className="grid grid-cols-12 gap-6 mt-5">
          <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            <div>
              <p className="text-lg font-medium">Protein Type Dropdown</p>
            </div>
            <div>
              <Link to={"/add-protein-type"}>
  ...
  export default ProteinTypeOption;
