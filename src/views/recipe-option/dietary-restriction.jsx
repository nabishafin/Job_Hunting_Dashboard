import {
  ...
  function DietaryRestrictionOption() {
    ...
    const handleDelete = async (id) => {
      try {
        const response = await deleteData(`${DIETARY_RESTRICTION_DROPDOWN}/${id}`);
      ...
      <>
        ...
        <div className="grid grid-cols-12 gap-6 mt-5">
          <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            <div>
              <p className="text-lg font-medium">Dietary Restriction Dropdown</p>
            </div>
            <div>
              <Link to={"/add-dietary-restriction"}>
  ...
  export default DietaryRestrictionOption;
