import {
  ...
  function PreparationOption() {
    ...
    const handleDelete = async (id) => {
      try {
        const response = await deleteData(`${PREPARATION_DROPDOWN}/${id}`);
        toast.success("Preparation deleted successfully");
      ...
      <>
        ...
        <div className="grid grid-cols-12 gap-6 mt-5">
          <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            <div>
              <p className="text-lg font-medium">Preparation Dropdown</p>
            </div>
            <div>
              <Link to={"/add-preparation-type"}>
  ...
  export default PreparationOption;
